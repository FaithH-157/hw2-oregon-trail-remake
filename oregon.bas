...
240 PRINT "THIS PROGRAM SIMULATES A TRIP OVER THE ZOMBIE APOCALYPSE FROM"
250 PRINT "NEW YORK CITY, NEW YORK TO PASADENA, CALIFORNIA IN 2021."
260 PRINT "YOUR TEAM OF FIVE WILL COVER THE 2770 MILE TO SEND THE VACCINE"
270 PRINT "TO THE LAST ZOMBIE-OCCUPIED REGION IN 5-6 MONTHS --- IF YOU MAKE IT ALIVE."
280 PRINT
290 PRINT "YOU HAD SAVED $900 TO SPEND FOR THE TRIP, AND YOU'VE JUST"
300 PRINT "   PAID $200 FOR A PICK-UP TRUCK."
310 PRINT "YOU WILL NEED TO SPEND THE REST OF YOUR MONEY ON THE"
320 PRINT "   FOLLOWING ITEMS:"
330 PRINT
340 PRINT "     ENGINE - YOU CAN SPEND $200-$300 ON YOUR TEAM"
350 PRINT "            THE MORE YOU SPEND, THE FASTER YOU'LL GO"
360 PRINT "               BECAUSE YOU'LL HAVE BETTER ENGINE"
370 PRINT
...
420 PRINT "            YOU WILL NEED BULLETS FOR ATTACKS BY ZOMBIES"
...
520 PRINT
530 PRINT
540 PRINT "YOU CAN SPEND ALL YOUR AMPLES BEFORE YOU START YOUR TRIP -"
550 PRINT "OR YOU CAN SAVE SOME OF YOUR CASH TO SPEND AT SHELTER ALONG"
560 PRINT "THE WAY WHEN YOU RUN LOW. HOWEVER, ITEMS COST MORE AT"
570 PRINT "THE SHELTER. YOU CAN ALSO GO HUNTING ALONG THE WAY TO GET"
580 PRINT "MORE FOOD."
...
830 PRINT
840 PRINT
850 PRINT "HOW MUCH DO YOU WANT TO SPEND ON YOUR ENGINE UPGRADE";
860 INPUT A
...
1190 PRINT
1200 PRINT "MONDAY MARCH 29 2021"
1210 PRINT
1220 GOTO 1750
...
1700 PRINT "YOUR TEAM DIES IN THE FIRST BLIZZARD OF WINTER"
1710 GOTO 5170
1720 PRINT "2021"
1730 PRINT
...
2070 X1=X1*(-1)
2080 PRINT "DO YOU WANT TO (1) STOP AT THE NEXT SHELTER, (2) HUNT, ";
...
3660 PRINT "PICK-UP TRUCK TIRE PUMPS--LOSE TIME AND SUPPLIES FIXING IT"
3670 LET M=M-15-5*RND(1)
3680 LET M1=M1-8
3690 GOTO 4710
3700 PRINT "ENGINE GETS A LITTLE RUSTY---SLOWS YOU DOWN REST OF TRIP"
3710 LET M=M-25
3720 LET A=A-20
3730 GOTO 4710
3740 PRINT "BACK LUCK---YOUR TEAMMATE BROKE HER ARM"
3750 PRINT "YOU HAD TO STOP AND USE SUPPLIES TO MAKE A SLING"
3760 M=M-5-4*RND(1)
3770 M1=M1-2-3*RND(1)
3780 GOTO 4710
3790 PRINT "LOSTS MANY CASES WITH VACCINE SAMPLE---SPEND TIME LOOKING FOR IT"
3800 M=M-17
3810 GOTO 4710
3820 PRINT "LOSTS FEW CASES WITH VACCINE SAMPLE---SPEND HALF THE DAY LOOKING FOR HIM"
3830 M=M-10
3840 GOTO 4710
...
4040 PRINT "YOU GOT SHOT IN THE LEG AND THEY POPS THE TIRE OF THE TRUCK"
4050 K8=1
...
4120 GOTO 4710
4130 PRINT "THERE WAS A SMALL FIRE IN YOUR TRUCK--FOOD AND SUPPLIES DAMAGE!"
4140 F=F-40
4150 B=B-400
...
4270 GOTO 5170
4280 GOTO 4710
4290 PRINT "TRUCK GETS SWAMPED FORDING RIVER--LOSE FOOD AND CLOTHES"
4300 F=F-30
4310 C=C-20
4320 M=M-20-20*RND(1)
4330 GOTO 4710
4340 PRINT "ZOMBIE ATTACK!"
4350 GOSUB 6140
4360 IF B>39 THEN 4410
4370 PRINT "YOU WERE TOO LOW ON BULLETS--"
4380 PRINT "THE ZOMBIES OVERPOWERED YOU"
4390 K8=1
4400 GOTO 5120
...
4660 GOTO 4710
4670 PRINT "HELPFUL VILLAGERS SHOW YOU WHERE TO FIND MORE FOOD"
4680 F=F+14
4690 GOTO 4710
4700 REM ***MOUNTAINS***
...
4790 PRINT "TRUCK DAMAGED!---LOSE TIME AND SUPPLIES"
4800 M1=M1-5
4810 B=B-200
...
5340 PRINT "DIDN'T MAKE IT TO THE PASADENA, CALIFORNIA AND COULD NOT DELIVER THE VACCINE"
5350 PRINT "BETTER LUCK NEXT TIME"
5360 PRINT
5370 PRINT
5380 PRINT TAB(30);"SINCERELY"
5390 PRINT
5400 PRINT TAB(17);"CENTERS FOR DISEASE CONTROL AND PREVENTION"
...
5470 PRINT "YOU FINALLY ARRIVED AT PASADENA, CALIFORNIA"
...
5710 D3=D3-93
5720 PRINT "JULY ";D3;" 2021"
5730 GOTO 5920
5740 IF D3>155 THEN 5780
5750 D3=D3-124
5760 PRINT "AUGUST ";D3;" 2021"
5770 GOTO 5920
5780 IF D3>185 THEN 5820
5790 D3=D3-155
5800 PRINT "SEPTEMBER ";D3;" 2021"
5810 GOTO 5920
5820 IF D3>216 THEN 5860
5830 D3=D3-185
5840 PRINT "OCTOBER ";D3;" 2021"
5850 GOTO 5920
5860 IF D3>246 THEN 5900
5870 D3=D3-216
5880 PRINT "NOVEMBER ";D3;" 2021"
5890 GOTO 5920
5900 D3=D3-246
5910 PRINT "DECEMBER ";D3;" 2021"
5920 PRINT
